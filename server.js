...
function startServer() {
    ...
    app.get(`/resume/index.html`, function (request, response) {
        response.sendFile(path.resolve('public', 'resume', 'index.html'))
    })
    app.get(`/test-html/index.html`, function (request, response) {
        response.sendFile(path.resolve('public', 'test_html', 'index.html'))
    })
